...
public:
    ...
    void setPeriod(::Ice::Int __p_period)
    {
        setPeriod(__p_period, 0);
    }
    void setPeriod(::Ice::Int __p_period, const ::Ice::Context& __ctx)
    {
        setPeriod(__p_period, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_setPeriod(::Ice::Int __p_period, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_setPeriod(__p_period, 0, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent));
    }
    ::Ice::AsyncResultPtr
    begin_setPeriod(::Ice::Int __p_period, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_setPeriod(__p_period, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_setPeriod(::Ice::Int __p_period, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_setPeriod(__p_period, &__ctx, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_setPeriod(::Ice::Int __p_period, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_setPeriod(__p_period, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
#endif

    ::Ice::AsyncResultPtr begin_setPeriod(::Ice::Int __p_period)
    {
        return begin_setPeriod(__p_period, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setPeriod(::Ice::Int __p_period, const ::Ice::Context& __ctx)
    {
        return begin_setPeriod(__p_period, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setPeriod(::Ice::Int __p_period, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setPeriod(__p_period, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setPeriod(::Ice::Int __p_period, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setPeriod(__p_period, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setPeriod(::Ice::Int __p_period, const ::RoboCompCommonBehavior::Callback_CommonBehavior_setPeriodPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setPeriod(__p_period, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setPeriod(::Ice::Int __p_period, const ::Ice::Context& __ctx, const ::RoboCompCommonBehavior::Callback_CommonBehavior_setPeriodPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setPeriod(__p_period, &__ctx, __del, __cookie);
    }
...
public:
    ...
    void setParameterList(const ::RoboCompCommonBehavior::ParameterList& __p_l)
    {
        setParameterList(__p_l, 0);
    }
    void setParameterList(const ::RoboCompCommonBehavior::ParameterList& __p_l, const ::Ice::Context& __ctx)
    {
        setParameterList(__p_l, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_setParameterList(const ::RoboCompCommonBehavior::ParameterList& __p_l, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_setParameterList(__p_l, 0, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent));
    }
    ::Ice::AsyncResultPtr
    begin_setParameterList(const ::RoboCompCommonBehavior::ParameterList& __p_l, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_setParameterList(__p_l, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_setParameterList(const ::RoboCompCommonBehavior::ParameterList& __p_l, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_setParameterList(__p_l, &__ctx, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_setParameterList(const ::RoboCompCommonBehavior::ParameterList& __p_l, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_setParameterList(__p_l, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
#endif

    ::Ice::AsyncResultPtr begin_setParameterList(const ::RoboCompCommonBehavior::ParameterList& __p_l)
    {
        return begin_setParameterList(__p_l, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setParameterList(const ::RoboCompCommonBehavior::ParameterList& __p_l, const ::Ice::Context& __ctx)
    {
        return begin_setParameterList(__p_l, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setParameterList(const ::RoboCompCommonBehavior::ParameterList& __p_l, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setParameterList(__p_l, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setParameterList(const ::RoboCompCommonBehavior::ParameterList& __p_l, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setParameterList(__p_l, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setParameterList(const ::RoboCompCommonBehavior::ParameterList& __p_l, const ::RoboCompCommonBehavior::Callback_CommonBehavior_setParameterListPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setParameterList(__p_l, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setParameterList(const ::RoboCompCommonBehavior::ParameterList& __p_l, const ::Ice::Context& __ctx, const ::RoboCompCommonBehavior::Callback_CommonBehavior_setParameterListPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setParameterList(__p_l, &__ctx, __del, __cookie);
    }
...
public:
    ...
    ::IceInternal::ProxyHandle<CommonBehavior> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<CommonBehavior*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
